...
if(isset($_POST['submit']))
{
  ...
  $emp_password=$_POST['emp_password'];
	if($password===$cpassword)
	{
  	...
  	$res_u = mysqli_query($conn, "SELECT username FROM personal_users WHERE username='$username'");
      ...
      if(mysqli_num_rows($emp_id1) > 0){
        ...
        $e_id=$fetch['emp_id'];
          ...
          $a=mysqli_query($conn, "INSERT INTO `personal_users`(`username`, `password`, `reg_date`, `emp_id`) VALUES ('$username', '$password',now(),$e_id)");
        if($a>0){
          //echo"Data Inserted";
          $sql = "SELECT user_id FROM personal_users WHERE username='$username'";
...
<title>Personal User Registration</title>
</head>
<body>
...
<center><h1>Personal User Registration</h1></center>
<div class="container">
<form action="register.php" method="post">
  ...
  <center>Already have a Personal account? <a href="login.php">Log In</a></center>
