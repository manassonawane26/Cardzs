...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$con=mysqli_connect('localhost','root','','cardzs');
		if (!mysqli_query($con,"INSERT INTO personal_cardzs (`user_id`, `owner_name`, `phone_no`, `email`, `whatsapp_no`, `location_url`, `address`, `city_name`, `facebook_url`, `instagram_url`, `twitter_url`, `youtube_url`, `contact_nos`, `cardzs_id`, `profile_img`, `cover_img1`, `cover_img2`, `cover_img3`, `cover_img4`, `cover_img5`, `cover_img6`, `cover_img7`, `cover_img8`, `cover_img9`, `cover_img10`, `status`, `about`, `web_url`, `relationship_status`, `gender`, `dob`, `works_at`, `school_name`, `college_name`) VALUES ($user_id,'$owner_name',$phone_no,'$email',$whatsapp_no, '$location_url', '$address','$city_name','$facebook_url', '$instagram_url', '$twitter_url', '$youtube_url', '$contact_nos','$cardzs_id','$profile_img','$cover_img1','$cover_img2','$cover_img3','$cover_img4','$cover_img5','$cover_img6','$cover_img7','$cover_img8','$cover_img9','$cover_img10','$status','$about','$web_url','$relationship_status','$gender','$dob','$works_at','$school_name','$college_name')")){
...
<html>
<head>
	<title>&emsp;&emsp;Complete Your Profile</title>
...
<center><center><h1>User Profile</h1></center>
</center>
<div class="container">
...
<?php if($fine!=""){?>
		...
		<div class="row">
	      ...
	      <div class="col-75">		
				<textarea name="about" rows="3" cols="35" value="<?php echo $about;?>" placeholder="Enter About" ></textarea><br/>
	      </div>
	    </div>
