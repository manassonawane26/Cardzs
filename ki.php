<?php
  ...
  $result=mysqli_query($db,"select * from personal_cardzs where cardzs_id = '$file'");
...
<!--Dob-->
<br>
<img src="https://drive.google.com/thumbnail?id=13nq7WJnOu88D2ljB49s8D-nl6ON5M2Uc" class="responsiveicons" width="10" height="10"  align="left"><br><br>
<p style="text-align:left;"><?php echo $dob;?></p>
                                 
<!--Relationship Status-->
<br>
<img src="https://drive.google.com/thumbnail?id=1x0u8TYSOgYfF-7WyIHrugFbdz-WeyOVN"  class="responsiveicons" width="10" height="10"  align="left"><br><br>
<p style="text-align:left;"><?php echo $relationship_status;?></p>
                                 


<!--Works At-->
<br>
<img src="https://drive.google.com/thumbnail?id=1ziTXINcQO9RtaDs7B7EVbFGzEBHviEjU"  class="responsiveicons" width="10" height="10"  align="left"><br><br>
<p style="text-align:left;"><?php echo $works_at;?></p>
                                  
<!--College-->
<br>
<img src="https://drive.google.com/thumbnail?id=1PlgCzTvwhqTnuHo8kt9IMRC2ayAT9OCp"  class="responsiveicons" width="10" height="10"  align="left"><br><br>
<p style="text-align:left;"><?php echo $college_name;?></p>
                                 
<!--School-->
<br>
<img src="https://drive.google.com/thumbnail?id=1TbLlWhc0LE8UmzaJDqlQYc2wMKzBBVM7"  class="responsiveicons" width="10" height="10"  align="left"><br><br>
<p style="text-align:left;"><?php echo $school_name;?></p>
...
<p style="text-align:left;"><?php echo $city_name;?></p>
                                   

<!--Address-->
<br>
<img src="https://drive.google.com/thumbnail?id=1gwM9ynTZBexEEo-TU62sK8ddn1_n8P4f"  class="responsiveicons" width="10" height="10" align="left"><br><br>
...
<p style="text-align:left;"><?php echo nl2br($about);?></p>
