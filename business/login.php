...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card">
	...
	<center><h1>Business User Login</h1></center>
	<div class="container">
...
<center>Need a Business account? <a href="register.php">Sign Up </a></center>
...
if(isset($_POST['submit'])){
	...
	$data=mysqli_query($con, "SELECT * FROM `business_users` WHERE username='$username' and password='$password'");
	if($data){
