...
if(isset($_SESSION['user_id']))
{
	...
	if(isset($_POST['delete'])){
		$delete=$_POST['delete'];
		mysqli_query($db,"UPDATE `business_cardzs` SET $delete = null where user_id=$user_id");
	}

	$result=mysqli_query($db,"select * from business_cardzs where user_id = $user_id ");
...
<?PHP
	...
	if(isset($_POST['update'])){
		...
		if (!$con -> query("update business_cardzs set business_name='$business_name', owner_name='$owner_name',`phone_no`=$phone_no, `email`='$email', `gst_no`='$gst_no', `whatsapp_no`=$whatsapp_no, `location_url`='$location_url', `address`='$address', `about_us`='$about_us', `services`='$services', `city_name`='$city_name', `open_hours`='$open_hours', `facebook_url`='$facebook_url', `instagram_url`='$instagram_url', `twitter_url`='$twitter_url', `youtube_url`='$youtube_url', `contact_nos`='$contact_nos',`web_url`='$web_url' where user_id=$user_id") ) {
		...
		if(!empty($_FILES['profile_img']['tmp_name'])){
			if(($_FILES['profile_img']['size'] >= 2097152)) {
				...
				$con -> query("update business_cardzs set `profile_img`='$profile_img' where user_id=$user_id");
		}}
		if(!empty($_FILES['cover_img1']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img1`='$cover_img1' where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img2']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img2`='$cover_img2' where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img3']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img3`='$cover_img3'  where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img4']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img4`='$cover_img4' where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img5']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img5`='$cover_img5' where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img6']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img6`='$cover_img6' where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img7']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img7`='$cover_img7' where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img8']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img8`='$cover_img8' where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img9']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img9`='$cover_img9' where user_id=$user_id");
		}
		if(!empty($_FILES['cover_img10']['tmp_name'])){
			$con -> query("update business_cardzs set `cover_img10`='$cover_img10' where user_id=$user_id");
		}
	}
    ...
    <div class="row">
      ...
      <div class="col-75">
	    ...
	    <div class="row">
	      ...
	      <div class="col-75">		
				<input type="text" name="web_url" value="<?php echo $web_url;?>" placeholder="Enter Website Url" /><br/>
	      </div>
	    </div>
		...
		<div class="row">
	      ...
	      <div class="col-75">		
				<textarea name="about_us"   placeholder="Enter About" ><?php echo $about_us;?></textarea><br/>
	      </div>
	    </div>
		...
		<div class="row">
	      ...
	      <div class="col-75">		
				<textarea name="services"  placeholder="Enter Services" ><?php echo $services;?></textarea><br/>
	      </div>
	    </div>
		...
		<div class="row">
	      ...
	      <div class="col-75">		
				<textarea name="open_hours"  placeholder="Enter Business Timing"><?php echo $open_hours;?></textarea><br/>
	      </div>
	    </div>
